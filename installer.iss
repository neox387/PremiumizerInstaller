...
begin
  ...
  Exec(Nssm, ExpandConstant('install "{#AppServiceName}" "{app}\Python\python.exe" """{app}\{#AppName}\premiumizer\Premiumizer.py""" --windows'), '', SW_HIDE, ewWaitUntilTerminated, ResultCode)
